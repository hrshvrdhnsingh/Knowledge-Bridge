...
// To display the pie charts on the instructor dashboard.
const InstructorChart = ({ courses }) => {
    ...
    return (
        <div
            ...
            className="w-10/12 sm:w-full h-full flex flex-col gap-3 sm:px-2"
        >
            ...
            <div className="">
                <Pie
                    ...
                    options={options}
                    className="h-[40vh] sm:h-[45vh] text-lg sm:text-base"
                />
            </div>
        </div>
    );
