...
const RenderTotalAmount = () => {
    ...
    return (
        <div className='bg-richblack-700 bg-opacity-50 rounded-xl h-max flex flex-col p-4 w-max'>
            ...
            <button onClick={handleBuyCourse} className='bg-yellow-400 p-2 flex justify-center items-center rounded-xl cursor-pointer hover:scale-95 transition-[1s]'>Buy Now</button>
        </div>
    )
}
