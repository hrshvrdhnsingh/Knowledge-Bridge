    ...
    return (
        <div className='flex flex-col w-screen min-h-screen items-center sm:mt-8'>
            <div className='relative w-full mb-64 sm:mb-48 h-[66vh] bg-richblack-800 light-bg flex justify-center items-center flex-col overflow-visible'>
                <div className='w-7/12 sm:w-full overflow-hidden'>
                ...
                <div className='flex absolute w-full justify-center items-center top-[73%] sm:top-[91%] gap-8 sm:gap-3 px-32 sm:px-2'>
                    <div className='w-[33%]'><img src={AboutUs1} alt=''className='rounded-3xl' /></div>
                    <div className='w-[33%]'><img src={AboutUs2} alt=''className='rounded-3xl'/></div>
                    <div className='w-[33%]'><img src={AboutUs3} alt=''className='rounded-3xl'/></div>
                </div>
            </div>
            ...
            <div className='flex w-9/12 justify-between items-center sm:w-full sm:flex-col-reverse'>
                ...
                <div className='w-[50%] sm:w-[100%] p-12 sm:p-4'><img src={Founding} alt='' className='rounded-3xl'/></div>
            </div>
            <div className='flex w-9/12 justify-between items-center gap-32 p-4 mt-24 sm:flex-col sm:gap-12 sm:w-full'>
                <div className='flex justify-center items-center flex-col gap-6 sm:gap-3'>
            ...
            <div className='w-screen light-bg2 mt-40 flex justify-evenly py-16 sm:py-8'>
            ...
            <div className='w-10/12 flex flex-col h-[90vh] mt-40 sm:h-max sm:w-full'>
                <div className='flex h-[50%] sm:flex-col sm:h-max sm:items-center sm:justify-center'>
                    <div className='w-[50%]  sm:w-11/12 sm:rounded-xl flex flex-col p-3 gap-1'>
                        <h1 className='text-white font-bold text-4xl sm:text-3xl p-4'>World-class learning for <HighLightText text='Anyone'/>, from <HighLightText text='Anywhere' /></h1>
                    ...
                    <div className='w-[25%]  sm:w-11/12 sm:rounded-xl flex-col flex justify-center p-4 gap-8 bg-richblack-600'>
                    ...
                    <div className='w-[25%]  sm:w-11/12 sm:rounded-xl bg-richblack-800 flex-col flex justify-center p-4 gap-8'>
                        <h3 className='text-white text-xl'>Curriculum Based on Industry Needs</h3>
                        <p className='text-zinc-400'>Save time and money! The Belajar curriculum is made to be easier to understand and in line with industry needs.</p>
                    </div>
                </div>
