...
exports.getEnrolledCourses = async (req, res) => {
    try {
        ...
        console.log("Student before objectifying->", userDetails)
        ...
        console.log("Student after objectifying->", userDetails)
        ...
        for (const course of userDetails.courses) {
            ...
            for (const courseContent of course.courseContent) {
                totalDurationInSeconds += courseContent.subSection.reduce((acc, curr) => acc + parseInt(curr.timeDuration), 0);
