...
exports.createCourse = async (req, res) => {
    try{
        ...
        try{
            if(!courseName || !courseDescription || !whatYouWillLearn || !price || !_tag.length || !thumbnail || !thumbnail || !_instructions.length){
        ...
        console.log('Already course :', alreadyExists)
        ...
        console.log('Thmbnail Image : ', thumbnailImage)
        //Now, create a new course entry in the database
        const newCourse = await Course.create({
            courseName, courseDescription,
            instructor: instructorDetails._id, whatYouWillLearn: whatYouWillLearn,
            price, tag, category: categoryDetails._id, status: status, instructions,
        ...
        console.log("New Course Details : ", categoryDetails2);
...
exports.showAllCourses = async (req, res) => {
    try{
        const allCourses = await Course.find({}, {instructor: true, ratingAndReviews: true, courseName: true, studentsEnrolled: true,
                                            thumbnail: true, price: true}).populate('instructor').exec();
