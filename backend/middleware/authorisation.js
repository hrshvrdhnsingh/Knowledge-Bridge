...
exports.isStudent = async (req, res, next) => {
    try{
        if(req.user.accountType !== 'Student') { //Extracting this data from the 'decode' object created during login
...
exports.isInstructor = async (req, res, next) => {
    try{
        ...
        if(userDetails.accountType !== 'Instructor') { //Extracting this data from the 'decode' object created during login
            return res.status(403).json({
                succes: false,
...
exports.isAdmin = async (req, res, next) => {
    try{
        ...
        if(userDetails.accountType !== 'Admin') { //Extracting this data from the 'decode' object created during login
            return res.status(403).json({
                succes: false,
