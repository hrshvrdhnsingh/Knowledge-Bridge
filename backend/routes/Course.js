...
const {
  createCourse, showAllCourses, getCourseDetails, getFullCourseDetails,
...
const { getAllCategories, createCategory, categoryPageDetails, getAllCategoriesDetails } = require("../controller/Category")
